    ...
    return /*html*/ `
        ...
        <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
          ...
          <div class="w-full h-auto">
            ...
            <form class="mt-6" id="formSignin" method="POST">
              <div>
            ...
            <p class="mt-8"><a href="/" class="flex flex-row gap-[1rem] text-gray-500 hover:text-blue-700 font-regular"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
